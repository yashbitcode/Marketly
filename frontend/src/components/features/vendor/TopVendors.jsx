    ...
    return (
        <div className="my-20 font-inter">
            ...
            <Container className="mx-auto gap-4 mt-8 px-4 flex flex-wrap justify-center">
                ...
                {
                    Array.from({length: 5}).map(() => <TopVendorCard storeImg={"https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg"} storeName={"EasyFashion Ltd."} avgRating={3.7} />)
                }
            </Container>
        </div>
    );
