...
const JoinAsSeller = () => {
    return (
        <div className="bg-green w-full py-15 font-inter">
            <h1 className="text-base-white text-5xl max-sm:text-4xl text-center font-semibold ">
                Join As A Seller
            </h1>
            <p className="text-base-white mt-4 text-center italic">
                Build Your Brand With Marketly
            </p>

            <Container className="flex mt-10 px-4 mx-auto justify-center gap-20 items-center max-[900px]:gap-15 max-[900px]:flex-col">
