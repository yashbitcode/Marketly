...
const Hero = () => {
    return (
        <Container className="font-inter grid grid-rows-2 max-md:flex max-md:flex-col grid-cols-4 md-plus:h-135 mx-auto mt-8 max-w-292 gap-4 px-4">
            <div className="rounded-base col-span-3 max-md-plus:col-span-4 p-7 bg-light-green w-full flex relative">
                <div className="flex flex-col gap-5 max-md-plus:items-center justify-center max-md-plus:text-center mx-auto">
                    <div>
                        <h1 className="text-4xl text-green font-semibold max-sm-440:text-2xl">Discover Everything</h1>
                    ...
                    <Button className="uppercase bg-green text-white w-fit">shop now</Button>
                </div>
                <div className="w-full max-w-200 relative -top-18 -right-13 max-md-plus:hidden">
                    <img src="vendor.svg" alt="vendor" className="w-full" />
                </div>
            </div>
            <div className="rounded-base md-plus:row-span-2 max-md:col-span-4 max-md-plus:col-span-2 bg-amber-900/15 p-5 max-md-plus:order-2 overflow-hidden w-full relative flex flex-col  max-md-plus:text-center">

                <div className="flex flex-col gap-4 w-full max-md-plus:items-center justify-center max-md-plus:h-full">
                    <div>
                        <h1 className="text-2xl max-md-plus:text-3xl text-amber-900 font-semibold max-sm-440:text-2xl">Trending Products</h1>
                    ...
                    <Button className="uppercase bg-amber-900 text-white w-fit mt-4">shop now</Button>
                </div>
            ...
            <div className="rounded-base col-span-2 bg-blue-500/15 p-4 flex items-center max-md:col-span-4">
                <div className="flex flex-col gap-4 w-full h-full max-md-plus:items-center justify-center max-md-plus:text-center mx-auto">
                    <div>
                        <h1 className="text-3xl text-blue-500 font-semibold max-sm-440:text-2xl">Hot Deals</h1>
                    ...
                    <Button className="uppercase bg-blue-500 text-white w-fit mt-4">shop now</Button>
                </div>
            ...
            <div className="rounded-base bg-orange/15 flex justify-center items-center flex-col p-4 max-md-plus:hidden">
                ...
                <Button className="uppercase bg-orange text-white w-fit">shop now</Button>
            </div>
