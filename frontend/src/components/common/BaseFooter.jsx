    ...
    return (
        <div className="bg-green font-inter">
            <Container className="px-4 py-10 max-w-6xl mx-auto flex justify-between max-[860px]:flex-col gap-10">
                <div>
                    <h1 className="text-xl font-medium text-base-white">Get Quality Products By Great Sellers</h1>
                    ...
                    <div className="mt-7">
                        ...
                        <div className="flex gap-4 mt-2">
                            {
                                SOCIAL_MEDIA.map((el, idx) => <div key={idx} className={`size-10 flex justify-center rounded-full items-center ${el.bgColor}`}>{<el.icon strokeWidth={1.5} className="text-base-white" />}</div>)
                            }
                        </div>
                    </div>
                </div>
            ...
            <div className="py-3 text-center italic text-base-white shadow-base shadow-base-white">
                ...
                © 2026 Marketly. Empowering sellers. <span className="text-orange">Connecting buyers.</span>
